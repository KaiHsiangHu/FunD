...
#' data <- FunDdata.abu$data
#' dij <-  FunDdata.abu$dij
#' out <- AsyFD(data = data, distM = dij, datatype = "abundance")
#' # Type (2) incidence frequency data 
#' data(FunDdata.inc)
#' data <- FunDdata.inc$data
#' dij <-  FunDdata.inc$dij
...
#' }
#' @export
AsyFD <- function(data, distM, datatype = "abundance", q = c(0,1,2), nboot = 50, conf = 0.95, threshold = NULL){
...
#' }
#' @export
ObsFD <- function(data, distM, datatype = "abundance", q = c(0,1,2), nboot = 50, conf = 0.95, threshold = NULL){
...
#' data <- FunDdata.abu$data
#' dij <-  FunDdata.abu$dij
#' out <- iNEXTAUC(data = data, distM = dij, datatype = "abundance")
#' # Type (2) incidence frequency data 
#' data(FunDdata.inc)
#' data <- FunDdata.inc$data
#' dij <-  FunDdata.inc$dij
#' out <- iNEXTAUC(data = data, distM = dij, datatype = "incidence_freq")
#' }
#' @export
iNEXTAUC <- function(data, distM, datatype = "abundance", q = c(0,1,2), endpoint = NULL, 
  ...
  FUN <- function(e){
    if(class(dat) == "list"){
      ...
      temp$AUC.LCL[temp$AUC.LCL<0] <- 0; temp$SC.LCL[temp$SC.LCL<0] <- 0
      temp$SC.UCL[temp$SC.UCL>1] <- 1
      return(temp)
    }else{
      return(NULL)
...
#' data <- FunDdata.abu$data
#' dij <-  FunDdata.abu$dij
#' out <- AsyAUC(data = data, distM = dij, datatype = "abundance")
#' # Type (2) incidence frequency data 
#' data(FunDdata.inc)
#' data <- FunDdata.inc$data
#' dij <-  FunDdata.inc$dij
#' out <- AsyAUC(data = data, distM = dij, datatype = "incidence_freq")
#' }
#' @export
AsyAUC <- function(data, distM, datatype = "abundance", q = c(0,1,2), nboot = 50, conf = 0.95, tau = NULL){
...
#' data <- FunDdata.abu$data
#' dij <-  FunDdata.abu$dij
#' out <- ObsAUC(data = data, distM = dij, datatype = "abundance")
#' # Type (2) incidence frequency data 
#' data(FunDdata.inc)
#' data <- FunDdata.inc$data
#' dij <-  FunDdata.inc$dij
#' out <- ObsAUC(data = data, distM = dij, datatype = "incidence_freq")
#' }
#' @export
ObsAUC <- function(data, distM, datatype = "abundance", q = c(0,1,2), nboot = 50, conf = 0.95, tau = NULL){
